...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Des 2025 pada 17.42
...
(14, 'Starex Premium Transport', 'Pickup Klia to KL', 'assets/img/cars/mobil2.jpeg', 0, 0, 350, 0, 'yes'),
(16, 'Premium Private Cheufour', 'Tour in KL for 8 hours', 'assets/img/cars/mobil3.jpeg', 650, 650, 650, 650, 'yes'),
(17, '18 seater van for familly', 'Klia to KL', 'assets/img/cars/mobil4.jpeg', 350, 350, 350, 350, 'yes'),
(21, 'Luxury VIP Car', 'Pickupp Klia to KL', 'assets/img/cars/mobil5.jpeg', 500, 500, 500, 500, 'yes'),
(22, 'Bus 44 Seater', 'Pickuup KLIA to KL', 'assets/img/cars/mobil6.jpeg', 750, 777, 777, 777, 'yes'),
(23, 'VVIP Luxury car alphard 2024', 'Tour for 1 days', 'assets/img/cars/mobil7.jpeg', 1550, 967, 967, 967, 'yes'),
(24, 'Camry for 3 Person', 'Pickup Klia to Kuala Lumpur', 'assets/img/cars/mobil8.jpeg', 400, 11, 11, 11, 'yes'),
(25, 'Starla 5-7 Person', 'Private Chauffeur', 'assets/img/cars/mobill.jpeg', 350, 12, 12, 12, 'yes'),
(26, 'Transfer and pickup airport', 'Private service chauffeur', 'assets/img/cars/mobilll.jpeg', 300, 9, 9, 9, 'yes');

-- --------------------------------------------------------

--
-- Struktur dari tabel `clientcars`
--
...
--
-- Dumping data untuk tabel `clientcars`
--
...
--
-- Struktur dari tabel `rentedcars`
--
...
--
-- Dumping data untuk tabel `rentedcars`
--
...
--
ALTER TABLE `cars`
  MODIFY `car_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
-- AUTO_INCREMENT untuk tabel `rentedcars`
--
ALTER TABLE `rentedcars`
...
--
-- Ketidakleluasaan untuk tabel `clientcars`
--
ALTER TABLE `clientcars`
...
--
-- Ketidakleluasaan untuk tabel `rentedcars`
--
ALTER TABLE `rentedcars`
